...
export default function LoginPage() {
  ...
  async function handleLogin(e: React.FormEvent) {
    ...
    // Si no es admin verificar membresía
      ...
      <div style={{
        ...
        <form onSubmit={handleLogin}>
          <div style={{ marginBottom: '16px' }}>
            <label style={{ display: 'block', fontSize: '12px', color: 'rgba(255,255,255,0.4)', marginBottom: '7px' }}>
              Correo electrónico
            </label>
            <input
              type="email"
            ...
            <div style={{ position: 'relative' }}>
              <input
                ...
                style={{
                  width: '100%', background: 'rgba(255,255,255,0.05)',
                  border: '0.5px solid rgba(255,255,255,0.11)', borderRadius: '10px',
                  padding: '0 50px 0 14px', height: '46px', color: '#fff', fontSize: '14px',
                  fontFamily: 'inherit', outline: 'none', boxSizing: 'border-box'
                }}
              />
              <button type="button" onClick={() => setShowPass(!showPass)} style={{
                ...
                cursor: 'pointer', color: 'rgba(255,255,255,0.3)', fontSize: '12px', fontFamily: 'inherit'
              }}>
        ...
        <div style={{ borderTop: '0.5px solid rgba(255,255,255,0.07)', paddingTop: '20px', textAlign: 'center' }}>
          <p style={{ fontSize: '13px', color: 'rgba(255,255,255,0.3)', marginBottom: '12px' }}>
            ¿No tienes cuenta?{' '}
            <Link href="/register" style={{ color: '#4ade80', textDecoration: 'none' }}>
              Únete al club
            </Link>
          </p>
          <Link href="/" style={{ fontSize: '12px', color: 'rgba(255,255,255,0.2)', textDecoration: 'none' }}>
            ← Volver al inicio
          </Link>
        </div>
      </div>
